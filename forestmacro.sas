/********************************************************************************************************************
Macro name: ForestMacro

Written by: 

Creation date: Wednesday, July 15, 2015 16:49:30
...
Sample Macro call: %ForestMacro(data=forest, Study=StudyName, Group=GroupId, OddsRatio=or, LCL=lcl, UCL=ucl)
